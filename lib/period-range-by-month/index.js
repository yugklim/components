...
var _rangeElement = __webpack_require__(17);
    ...
    _createClass(PeriodRangeByMonth, [{
        ...
        value: function markSelectedPeriod(period, periods) {
            _lodash2.default.forEach(periods, function (p) {
                p.selected = p.selected || (p.begin || p.startDate) <= (period.begin || period.startDate) && (p.end || p.endDate) >= (period.end || period.endDate);
            });
        }
    }, {
        key: 'componentDidMount',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_periodRange2.default, _extends({ onPeriodClick: this.toggleRanges.bind(this) }, this.props))
                ),
                _react2.default.createElement(
                    'div',
...
PeriodRangeByMonth.defaultProps = {
    ...
    onRangeClick: function onRangeClick(period) {
        console.log('onRangeClick ' + period);
    },
    prevButtonDisabled: false,
    nextButtonDisabled: false
};

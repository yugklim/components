        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn-close-sidebar', type: 'button', onClick: this.props.onClose },
                        _react2.default.createElement('i', { className: 'icon-big-close' })
                    ),
                    _react2.default.createElement(
                        'div',
                        null,
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(4),p=__webpack_require__(7);__webpack_require__(1);var r=__webpack_require__(2);
...
var _normalizePeriod = __webpack_require__(23);

var _normalizePeriod2 = _interopRequireDefault(_normalizePeriod);
...
var PeriodRangeByMonth = function (_React$Component) {
    ...
    function PeriodRangeByMonth(props) {
        ...
        _this.handleEscClick = _this.handleEscClick.bind(_this);
        return _this;
    }
    ...
    _createClass(PeriodRangeByMonth, [{
        ...
        key: 'markSelectedPeriod',
        value: function markSelectedPeriod(period, periods) {
        ...
        key: 'dropRange',
        value: function dropRange(e) {
            e.stopPropagation();
            var selectedRange = this.state.selectedRange;

            var rangeClone = _lodash2.default.cloneDeep(selectedRange);
        ...
        key: 'handleEscClick',
        value: function handleEscClick(event) {
            if (event.keyCode == 27) {
                this.hideRanges();
            }
        }
        ...
        value: function render() {
            ...
            var complementedPeriods = complementPeriods ? complementPeriods(this.state.monthSelected, periods) : periods;
            this.markSelectedPeriod(selectedRange, complementedPeriods);
            return _react2.default.createElement(
                'div',
                { className: 'range-container', ref: this.setWrapperRef.bind(this) },
                _react2.default.createElement(
                    'div',
                    ...
                    selectedRange && selectedRange.begin && selectedRange.end ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'holder' },
                            PeriodRangeByMonth.noPeriodInfo
                        )
                    )
                ),
                _react2.default.createElement(
...
PeriodRangeByMonth.defaultProps = {
    ...
    onRangeClick: function onRangeClick(selectedRange) {
        console.log('onRangeClick ' + selectedRange);
    },
    prevButtonDisabled: false,
    nextButtonDisabled: false
};
...
PeriodRangeByMonth.noPeriodInfo = 'No selected period';
...
var RangeElement = function (_React$Component) {
    _inherits(RangeElement, _React$Component);

    function RangeElement() {
        _classCallCheck(this, RangeElement);

        return _possibleConstructorReturn(this, (RangeElement.__proto__ || Object.getPrototypeOf(RangeElement)).apply(this, arguments));
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.monthName ? proposedPeriod.begin.toLocaleString('en-us', { month: 'long' }).toUpperCase() : null
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'period-square-inner' },
                    _react2.default.createElement(
                        'p',
                        null,
                        proposedPeriod.begin.getDate(),
                        '-',
                        proposedPeriod.end.getDate()
                    )
                )
            );
        }
...
RangeElement.defaultProps = {
    proposedPeriod: {
        ...
        locked: false,
        selected: false,
        onClick: function onClick(proposedPeriod) {
            console.log('\'onRangeElementClick\' - ' + proposedPeriod);
        }
    }
};
...
exports.default = normalizePeriods;
...
//# sourceMappingURL=hrm-comps.js.map